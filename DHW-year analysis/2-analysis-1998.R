...
# Reduced dataframe.
bleach.reduced.1998 <- bleach_1998[, c("bin.score",dhw.column)]
...
pr.1998 <- generate_predictions(m.1998, 
                                newdata.1998$no.ev,
                                dhw.column)
pr.S.1998 <- generate_predictions(mS.1998, 
                                  newdata.1998$ev,
                                  dhw.column)

# Creating plot objects.
plot.1998 <- create_plot_object("1998 - No Eigenvectors", 
                                dhw.column,
                                x.label = " ",
                                pr.1998)
plot.S.1998 <- create_plot_object("1998 - Eigenvectors", 
                                  dhw.column,
                                  x.label = " ",
                                  pr.S.1998)
