#################################################################
##                 2016 Analysis - DHW * year                  ##
##                   By: Migdonio A. González                  ##
##                   Edited by: Sean Connolly                  ##
#################################################################
### Top 3 candidates.
candidate.number <- 1 # 4 EV
...
pr.2016 <- generate_predictions(m.2016, 
                                newdata.2016$no.ev,
                                dhw.column)
pr.S.2016 <- generate_predictions(mS.2016, 
                                  newdata.2016$ev,
                                  dhw.column)

# Creating plot objects.
plot.2016 <- create_plot_object("2016 - No Eigenvectors", 
                                dhw.column,
                                x.label = " ",
                                pr.2016)
plot.S.2016 <- create_plot_object("2016 - Eigenvectors", 
                                  dhw.column,
                                  x.label = " ",
                                  pr.S.2016)
