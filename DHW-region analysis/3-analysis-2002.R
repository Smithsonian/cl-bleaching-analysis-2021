...
# Reduced dataframe.
bleach.reduced.2002 <- bleach_2002[,c("bin.score",dhw.column,"region")]
...
pr.2002 <- generate_predictions(m.2002, newdata.2002$no.ev, dhw.column)
pr.2002$region <- factor(pr.2002$region, levels = c("North","Central","South"))

pr.S.2002 <- generate_predictions(mS.2002, newdata.2002$ev, dhw.column)
pr.S.2002$region <- factor(pr.S.2002$region, levels = c("North","Central","South"))

# Creating plot objects.
plot.2002 <- create_plot_object("2002", dhw.column, " ", " ", pr.2002)
plot.S.2002 <- create_plot_object("2002", dhw.column, " ", " ", pr.S.2002)
